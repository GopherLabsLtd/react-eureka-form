...
var ReactPhotoSwipe = function (_React$Component) {
    _inherits(ReactPhotoSwipe, _React$Component);

    function ReactPhotoSwipe(props) {
        _classCallCheck(this, ReactPhotoSwipe);

        var _this = _possibleConstructorReturn(this, (ReactPhotoSwipe.__proto__ || Object.getPrototypeOf(ReactPhotoSwipe)).call(this, props));

        _this.groupID = Math.floor(Math.random() * 1e8);
        return _this;
    }

    _createClass(ReactPhotoSwipe, [{
        key: "openPhotoSwipe",
    ...
    return ReactPhotoSwipe;
}(_react2.default.Component);

exports.default = ReactPhotoSwipe;
