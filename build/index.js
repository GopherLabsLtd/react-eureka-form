...
var _arrowForward = __webpack_require__(96);
    ...
    _createClass(EurekaForm, [{
        ...
        value: function componentDidMount() {
            ...
            this.setState(_extends({}, this.state, {
                ...
                // show first question
                var firstQuestion = _this2.state.questions[0];
        ...
        value: function _submit() {
            ...
            if (!this.state.wasSubmitted) {
                this.setState(_extends({}, this.state, {
                    ...
                    _this5.props.onSubmit(_this5.formRef);

                    // Disable all inputs
                    _this5.state.questions.forEach(function (question) {
                        question.querySelector('input, textarea, select').setAttribute("disabled", true);
                    });

                    // Remove next button
                    _this5.ctrlNext.style.display = "none";
                });
            }
        }
    }, {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.questions.map(function (question, i) {
                            return _react2.default.createElement(
                                'li',
                                { key: 'eureka-question-' + i },
                                _react2.default.createElement(
                                    'span',
                                    null,
                                    _react2.default.createElement(
                                        'label',
                                        { htmlFor: 'eureka-question-' + i },
                                        question.title
                                    )
                                ),
                                _react2.default.createElement('input', { id: 'eureka-question-' + i, name: 'eureka-question-' + i, type: question.inputType || "text" })
                            );
                        })
                    ),
                    _react2.default.createElement(
...
var _reactIconBase = __webpack_require__(97);
